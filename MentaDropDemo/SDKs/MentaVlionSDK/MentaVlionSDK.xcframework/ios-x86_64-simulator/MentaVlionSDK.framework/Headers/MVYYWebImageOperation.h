...
/**
 The MVYYWebImageOperation class is an NSOperation subclass used to fetch image 
 from URL request.
 ...
 */
@interface MVYYWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) MVYYImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   MVYYWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(MVYYWebImageOptions)options
                          cache:(nullable MVYYImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable MVYYWebImageProgressBlock)progress
                      transform:(nullable MVYYWebImageTransformBlock)transform
                     completion:(nullable MVYYWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
