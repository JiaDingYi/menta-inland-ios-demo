...
/**
 ...
 The animation can be played by MVYYAnimatedImageView.
 ...
 Sample Code:
    ...
    MVYYSpriteSheetImage *sprite;
    sprite = [[MVYYSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    MVYYAnimatedImageView *imgView = [MVYYAnimatedImageView new];
