...
/**
 ...
 Sample Code:
     ...
     MVYYFrameImage *image = [MVYYFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     MVYYAnimatedImageView *imageView = [MVYYAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface MVYYFrameImage : UIImage <MVYYAnimatedImage>
...
/**
 ...
 @return An initialized MVYYFrameImage object, or nil when an error occurs.
 */
