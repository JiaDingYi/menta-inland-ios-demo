...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, MVYYImageType) {
    MVYYImageTypeUnknown = 0, ///< unknown
    MVYYImageTypeJPEG,        ///< jpeg, jpg
    MVYYImageTypeJPEG2000,    ///< jp2
    MVYYImageTypeTIFF,        ///< tiff, tif
    MVYYImageTypeBMP,         ///< bmp
    MVYYImageTypeICO,         ///< ico
    MVYYImageTypeICNS,        ///< icns
    MVYYImageTypeGIF,         ///< gif
    MVYYImageTypePNG,         ///< png
    MVYYImageTypeWebP,        ///< webp
    MVYYImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, MVYYImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's canvas region.
     */
    MVYYImageBlendNone = 0,
 ...
 */
@interface MVYYImageFrame : NSObject <NSCopying>
...
@property (nonatomic) MVYYImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) MVYYImageBlendOperation blend;      ///< Frame blend operation.
...
/**
 ...
 Example:
    ...
    MVYYImageDecoder *decoder = [MVYYImageDecoder decoderWithData:data scale:2.0];
    UIImage image = [decoder frameAtIndex:0 decodeForDisplay:YES].image;
 
    // Decode image during download:
    NSMutableData *data = [NSMutableData new];
    MVYYImageDecoder *decoder = [[MVYYImageDecoder alloc] initWithScale:2.0];
 ...
 */
@interface MVYYImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) MVYYImageType type;          ///< Image data type.
 ...
 */
- (nullable MVYYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
...
/**
 ...
 @discussion It supports encoding single frame image with the type defined in MVYYImageType.
 It also supports encoding multi-frame image with GIF, APNG and WebP.
 
 Example:
    
    MVYYImageEncoder *jpegEncoder = [[MVYYImageEncoder alloc] initWithType:MVYYImageTypeJPEG];
    jpegEncoder.quality = 0.9;
    [jpegEncoder addImage:image duration:0];
    NSData jpegData = [jpegEncoder encode];
 
    MVYYImageEncoder *gifEncoder = [[MVYYImageEncoder alloc] initWithType:MVYYImageTypeGIF];
 ...
 */
@interface MVYYImageEncoder : NSObject

@property (nonatomic, readonly) MVYYImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(MVYYImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(MVYYImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(MVYYImageDecoder *)decoder type:(MVYYImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @see mvyy_isDecodedForDisplay
 */
- (instancetype)mvyy_imageByDecoded;
 ...
 */
@property (nonatomic) BOOL mvyy_isDecodedForDisplay;
 ...
 */
- (void)mvyy_saveToAlbumWithCompletionBlock:(nullable void(^)(NSURL * _Nullable assetURL, NSError * _Nullable error))completionBlock;
 ...
 */
- (nullable NSData *)mvyy_imageDataRepresentation;
...
CG_EXTERN MVYYImageType MVYYImageDetectType(CFDataRef data);

/// Convert MVYYImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable MVYYImageTypeToUTType(MVYYImageType type);

/// Convert UTI (such as kUTTypeJPEG) to MVYYImageType.
CG_EXTERN MVYYImageType MVYYImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable MVYYImageTypeGetExtension(MVYYImageType type);



/// Returns the shared DeviceRGB color space.
CG_EXTERN CGColorSpaceRef MVYYCGColorSpaceGetDeviceRGB();

/// Returns the shared DeviceGray color space.
CG_EXTERN CGColorSpaceRef MVYYCGColorSpaceGetDeviceGray();

/// Returns whether a color space is DeviceRGB.
CG_EXTERN BOOL MVYYCGColorSpaceIsDeviceRGB(CGColorSpaceRef space);

/// Returns whether a color space is DeviceGray.
CG_EXTERN BOOL MVYYCGColorSpaceIsDeviceGray(CGColorSpaceRef space);



/// Convert EXIF orientation value to UIImageOrientation.
CG_EXTERN UIImageOrientation MVYYUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
CG_EXTERN NSInteger MVYYUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
CG_EXTERN CGImageRef _Nullable MVYYCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable MVYYCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable MVYYCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable MVYYCGImageCreateEncodedData(CGImageRef imageRef, MVYYImageType type, CGFloat quality);


/**
 Whether WebP is available in MVYYImage.
 */
CG_EXTERN BOOL MVYYImageWebPAvailable();
 ...
 */
CG_EXTERN NSUInteger MVYYImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable MVYYCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, MVYYImagePreset) {
    MVYYImagePresetDefault = 0,  ///< default preset.
    MVYYImagePresetPicture,      ///< digital picture, like portrait, inner shot
    MVYYImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    MVYYImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    MVYYImagePresetIcon,         ///< small-sized colorful images
    MVYYImagePresetText          ///< text-like
};
...
/**
 ...
 @param preset        Preset for different image type, default is MVYYImagePresetDefault.
 @return WebP data, or nil if an error occurs.
 */
CG_EXTERN CFDataRef _Nullable MVYYCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             MVYYImagePreset preset);
